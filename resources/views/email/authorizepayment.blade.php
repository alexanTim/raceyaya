        ...
        <tr>
            <td style=" text-align: center;">
                <table style=" width: 100%;">
                    <tbody><tr>
                        <td><h2>Thank Your For Registering</h2></td>
                    </tr>
                </tbody></table>
            </td>
        </tr>
                    ...
                    <tbody>
                        <tr>
                            <td style="text-align: left; padding-left: 80px;">Hello {{$firstname}},<br/>
                                <p>
                                    Your registration of event has been paid, but we still need to validate your additional requirement to race. 
</p>
<p>
Uploading of medical certificate can be done by going to profile and find upload section.
<br>
or simply clicking the link below that may take you to profile page:</p>
