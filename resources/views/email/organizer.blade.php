        ...
        <tr>
            <td>
                <table style="width:100%;">
                    <tbody>
                        <tr>
                            <td style="text-align: left; padding-left: 80px;">Hello Organizer,<br/>
                                <p>
                                    We are currently reviewing your application for your event. 
                                    For any concerns, email us at hello@raceyaya.com
                                </p>
                                <p>
