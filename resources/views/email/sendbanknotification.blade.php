                    ...
                    <tbody>
                        <tr>
                            <td style="text-align: left; padding-left: 80px;">Hello {{$firstname}},<br/>
                                <p>
                                    Welcome to raceyaya, your registration is pending.
                                    To complete or submit bank details ,just go to profile page and find bank detail fields and upload additional requirement for the race. 
                                </p>
                                <br/>
