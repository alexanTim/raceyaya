...
<body ng-url="{{config('app.url')}}" >
    ...
    <div @if(!empty($whatpage)) class="__header_about" @else class="__header"@endif>
      ...
      <div class="row">
          <div class="col-md-4">
            <span class="social_logo" ><a href="https://www.facebook.com/yourRaceYAYA"><img style="width: 13px;" src="{{ asset('images/h-icon-fb.png') }}"/></a></span>
            <span class="social_logo"> <a href="https://www.youtube.com/channel/UCHyW5I1Ms7UXSfkgqah4rsw"><img style="width: 21px;" src="{{ asset('images/h-icon-yt.png') }}"/></a></span>
            <span class="social_logo" ><img style="width: 18px;" src="{{ asset('images/h-icon-g.png') }}"/></span>
            <span class="social_logo" ><a href="https://www.instagram.com/yourraceyaya/"><img style="width: 15px;" src="{{ asset('images/h-icon-ins.png') }}"/></a></span>
           ...
           <div class="pull-right">            
              @guest
                      ...
                      @if (Route::has('register'))
                              ...
                              <a class="{{ (request()->is('create_account')) ? 'active' : '' }}" href="{{ route('create_account') }}">{{ __('Signup') }}</a>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-md navbar-light  shadow-sm menu-racenave">
          <div><img width="30%" src="{{ asset('images/h-Iogo.png') }}"/></div>
            <div class="container">
              <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">                 
                        ...
                        <li class="nav-item">
                          <a class="nav-link {{ (request()->is('ry/racers')) ? 'active' : '' }}" href="{{ route('racers-list') }}">{{ __('Racers') }}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ (request()->is('events')) || request()->is('view-racer-event-details/*') || request()->is('event-register/*')? 'active' : '' }}" href="{{ route('front-racer') }}">{{ __('Races') }}</a>
                        </li>                            
                        <li class="nav-item">
                            <a class="nav-link {{ (request()->is('blog')) ? 'active' : '' }}" href="{{ route('blog') }}">{{ __('Resources') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ (request()->is('organizers')) || (request()->is('vi/*/*')) ? 'active' : '' }}" href="{{route('Organizers') }}">{{ __('Organizers') }}</a>
                        </li>
                        <li class="nav-item">
                  ...
                  @foreach($all as $item)
                    <div class="content">
                        <div class="left" style="width: 55%;">
                          ...
                          <a href="{{url('/')}}/view-racer-event-details/{{$item->id}}">Register Here</a>
                        </div>                      
              ...
              <div class="form-group mx-sm-3 mb-2">             
				...
				<div class="row justify-content-center" style="padding-top: 51px;padding-bottom: 51px;">
					<div class="col-md-4" style="text-align:center">
						...
						<span class="social_logo" style="padding-right: 4px;" ><a href="https://www.facebook.com/yourRaceYAYA"><img style="width: 5%;" src="{{ asset('images/h-icon-fb.png') }}"/></a></span>
						<span class="social_logo" style="padding-right:10px;"><a href="https://www.youtube.com/channel/UCHyW5I1Ms7UXSfkgqah4rsw"><img style="width: 7%;" src="{{ asset('images/h-icon-yt.png') }}"/></a></span>
						<span class="social_logo" style="padding-right: 10px;"><img style="width: 6%;" src="{{ asset('images/h-icon-g.png') }}"/></span>
						<span class="social_logo" ><a href="https://www.instagram.com/yourraceyaya/"><img style="width: 6%;" src="{{ asset('images/h-icon-ins.png') }}"/></a></span>
						</div>
					</div>
				</div>
  ...
  <style>
    ...
    .s1-txt1 {
      ...
      <div id="cookie-notice" role="banner" class="cn-bottom bootstrap" style="text-align: center; color: rgb(255, 255, 255); background-color: #196d7a; visibility: visible; position: fixed; z-index: 5000; bottom: 1px; padding: 40px; width: 100%;border-top: 4px solid #ccc;">
        ...
        <a style="color:orange" href="{{route('term.of.use')}}"> Find out more </a>
