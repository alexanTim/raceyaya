	        ...
	        <div class="event_step_1">		
				...
				<div id="shop_event" class="event_step_4" style="display: none;">
		        	...
		        	<div class="shop_wrapper_payment_method_coupon" style="margin-bottom: 41px;">		        			
					    <div class="row">
					    	<div class="col-md-12">
						    	 este término de condiciones es condición este término de condiciones es condición este término de condiciones es condición este término de condiciones es condición este término de condiciones es condición este término de condiciones es condición				   
					   		</div>
						</div>
						<br/>
					    <div class="row">
