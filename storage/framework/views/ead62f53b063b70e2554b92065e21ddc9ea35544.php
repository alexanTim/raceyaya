                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-4" style="display:block;">
                      ...
                      <select id="country" name="country" class="modalcountry country_with_curr_modal form-control">
                              ...
                              <?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $valuesni): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  ...
                                  ?> 
                                    ...
                                    <?php if( $selected != ''): ?>
                                      <option selected="selected" value="<?php echo e($valuesni->name); ?>" ><?php echo e($valuesni->name); ?> - <?php echo e($valuesni->currency); ?></option>
                                    <?php else: ?> 
                                      <option value="<?php echo e($valuesni->name); ?>" ><?php echo e($valuesni->name); ?> - <?php echo e($valuesni->currency); ?></option>
                                    <?php endif; ?>                                         
                  ...
                  <div class="row" style="background:none;padding-top: 13px;margin: 0;color: #000;/*! font-size: 14px; */">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php if(isset($sports_category_list)): ?>
                              <select name="sports" class="form-control custom-select-sports-profile form-control browser-default custom-select input-grey">
                               <option value=""  selected disabled>Select Sports</option>
                                <?php $__currentLoopData = $sports_category_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option xid="<?php echo e($item->id); ?>" value="<?php echo e($item->name); ?>"><?php echo e($item->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                                   
                              </select>
                            <?php endif; ?>
                        </div>               
                ...
                <span style="border-left: 4px solid pink;height: 16px !important;display: inline-block;">&nbsp;</span> Add Map</h5>
                  ...
                  <div class="row upload_map_image_element common_element_map">  
                   ...
                   <div class="row upload_google_code_element common_element_map" style="display: none;">   
                      ...
                      <div class="col-md-12 mb-5">1. Search location <img style="width:100%" src="<?php echo e(asset('images/1-MAP.png')); ?>"> </div>
                      <div class="col-md-12">2. Click embed and copy <img style="width:100%" src="<?php echo e(asset('images/2-MAP.png')); ?>"> </div>
                </div>
...
<div class="modal fade" id="payment_method_event"  data-keyboard="false" data-backdrop="static">
      ...
      <div class="modal-content" style="border-radius: 0px !important;">
        ...
        <div class="modal-body">
          ...
          <div class="d" style="padding-left: 30px;padding-right: 30px;">
            ...
            <form action="<?php echo e(route('shop.inquire')); ?>" method="post">              
                    <div class="row">
  ...
  <div class="modal fade" id="oraganizer_term_and_condi"  data-keyboard="false" data-backdrop="static">
    ...
    <div class="modal-dialog modal-xl" style="">
      <div class="modal-content" style="border-radius: 0px !important;">      
        ...
        margin-left: 10px;">
        <form enctype="multipart/form-data"  id="form_registration_status_action" method="POST" action="<?php echo e(route('profile')); ?>">
                  ...
                  <div class="mb-4 col-md-6 col-sm-6 __credit_card_box__" style="padding-right: 0px;">	
                      <div class="radio_payment_select">
                          <div class="form-check">
                            ...
                            <img style="float:right ;width: 176px;" src="<?php echo e(asset('images/credi.png')); ?>">
                          </div>
                    ...
                    <div class="col-md-6 col-sm-6 __bank_deposit_box__" style="padding-right: 0px;">						     	
                        <div class="radio_payment_select">
                            <div class="form-check">
                              ...
                              <img style="float:right ;width: 178px;" src="<?php echo e(asset('images/bank-deposit.png')); ?>">
                            </div>
                        </div>	
                    </div>
                    <div class="col-md-6 col-sm-6 __raceyaya_box__" style="padding-right: 0px;">
                        <div class="radio_payment_select">
                            <div class="form-check">
                              ...
                              <img style="float:right ;width: 103px;" src="<?php echo e(asset('images/h-Iogo.png')); ?>">
                            </div>
                        </div>
                    </div>						     					   
                  </div>
          ...
          <h5 class="popcategory"><span style="border-left: 4px solid pink; height: 16px !important; display: inline-block;">&nbsp;</span>
           ...
           <div class="container PAYPAL_account_wrapper_box_modal">
            ...
            <h3><a style="color:#000;" href="https://paypal.com/">Go to paypal and login as business account.</a></h3>
              ...
              <div class="col-md-12 mt-5"><h2>3. Click My account</h2><img style="width:100%" src="<?php echo e(asset('public/images/11.png')); ?>"></div>
              <div class="col-md-12 mt-5"><h2>4. Click My Apps & Credentials and click LIVE button</h2><img style="width:100%" src="<?php echo e(asset('public/images/22.png')); ?>"></div>
              <div class="col-md-12 mt-5"><h2>5. Click Create app</h2><img style="width:100%" src="<?php echo e(asset('public/images/33.png')); ?>"></div>
              <div class="col-md-12 mt-5"><h2>6. Type App name and click create app</h2><img style="width:100%" src="<?php echo e(asset('public/images/44.png')); ?>"></div>
              <div class="col-md-12 mt-5"><h2>7. Copy Client ID and Secret key</h2><img style="width:100%" src="<?php echo e(asset('public/images/55.png')); ?>">
              <br><br>
              <img style="width:100%" src="<?php echo e(asset('public/images/66.png')); ?>">
              </div>
      ...
      <div class="modal-content" style="border-radius: 0px !important;">      
        ...
        <div class="modal-body" style="min-height:600px;margin-bottom:20px; text-align: justify;margin-right: 10px;margin-left: 10px;">
          <h5 class="popcategory"><span style="border-left: 4px solid pink; height: 16px !important; display: inline-block;">&nbsp;</span>
            Pending Payments</h5>
           <div class="container modal_cart_wrapper" style="padding-top:30px;padding-bottom:30px;">
              <form xd='d' method="POST" action="<?php echo e(route('profile')); ?>" id="shop_items_forms_pending" > 
                <input type="hidden" name="registration_id" class="registration_id"  value="">
                <input type="hidden" class="Payment_Method_Type" name="Payment_Method_Type" value="">
                <input type="hidden" class="event_id" name="event_id" value="">    
  ...
  </div>  <?php /**PATH E:\xampp7.3\htdocs\raceyaya\resources\views/modal.blade.php ENDPATH**/ ?>